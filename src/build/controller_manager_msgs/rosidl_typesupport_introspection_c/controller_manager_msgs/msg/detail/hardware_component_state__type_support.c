...
static rosidl_typesupport_introspection_c__MessageMember controller_manager_msgs__msg__HardwareComponentState__rosidl_typesupport_introspection_c__HardwareComponentState_message_member_array[7] = {
  {
    "name",  // name
