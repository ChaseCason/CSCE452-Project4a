...
static rosidl_typesupport_introspection_c__MessageMember controller_manager_msgs__srv__SwitchController_Request__rosidl_typesupport_introspection_c__SwitchController_Request_message_member_array[5] = {
  {
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, controller_manager_msgs, srv, SwitchController_Request)() {
  controller_manager_msgs__srv__SwitchController_Request__rosidl_typesupport_introspection_c__SwitchController_Request_message_member_array[4].members_ =
